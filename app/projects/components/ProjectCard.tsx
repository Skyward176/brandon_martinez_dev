...
return (
  <div className = 'flex flex-col w-full md:w-1/3 p-6 my-4 m-auto border-solid border-1 border-gray-400 rounded-lg'>
    ...
    <div className=''>
      ...
      <a className='text-teal-300 hover:underline hover:text-pink-300 text-xl'href={props.url}>Check it out here!</a>
    </div>
  </div>
);
}
